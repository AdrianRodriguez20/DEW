...
*/
var arrayNumeros:number[] = new Array(3);
for (let i:number = 0; i < 3; i++) {
    arrayNumeros[i] = Number(prompt("Introduce el número: " + i));
};

for (let i:number = 0; i < 3; i++) {
    let suma:number =arrayNumeros[i] + 1;
...
for (let i:number = 0; i < 5; i++) {
    ...
    var arrayNumeros:number[] = new Array(2);
...
*/
var palabraGanadora:string = "PARIS"; //establecemos la capital
